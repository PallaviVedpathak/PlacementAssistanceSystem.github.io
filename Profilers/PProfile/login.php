    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/profile-photo1.jpg" alt="Profile Photo" class="img-responsive">  
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              <i class="fa fa-times"></i>
              <h2 class="text-uppercase">Our Motive</h2>
            ...
            <div class="templatemo-content-widget white-bg col-1">
              ...
              <h3 class="text-uppercase">Placements</h3><hr>
              <div class="progress">
          ...
          <div class="templatemo-flex-row flex-content-row">
            ...
            <div class="col-1">
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <i class="fa fa-times"></i>
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">Other Placement Details</h2></div>
          ...
          <footer class="text-right">
           <p>Copyright &copy; 2021-22 TechnoTrends | Developed by
              <a href="" target="_parent">Rutuja B-Pallavi V</a>
            </p>
          </footer>         
        </div>
      </div>
